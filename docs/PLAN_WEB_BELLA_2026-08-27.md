...
| **G-11** | **Publicar los 5 sprints en producción (merge de las ramas `orq/bella-1..5` a `main`).** Ninguno está en vivo: los cinco quedaron en su rama por instrucción del cierre de sprint, así que frutiferia.com sigue mostrando la web vieja. Nada de BELLA-1..5 se puede probar en el teléfono hasta que esto pase, y G-6 depende de ello. Es de él porque PUSH = DEPLOY EN VIVO: lo ven todos los clientes en el momento en que ocurre. | 5 min | Sin esto, 5 sprints de trabajo no le mueven ni una venta. | Ahora. |
